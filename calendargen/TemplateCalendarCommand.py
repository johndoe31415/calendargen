...
from .CalendarTemplate import CalendarTemplate

class TemplateCalendarCommand(BaseCommand):
	def run(self):
		self._template = CalendarTemplate(self._args, self._args.input_file)
